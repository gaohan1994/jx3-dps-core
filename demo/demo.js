(function (factory) {
  ...
  async function Demo() {
    ...
    const BaseDps = await Yjj.total(); // const skills = BaseDps.skills.map((item) => {
    // item.showSkillInfo();
    ...
    console.log('基础dps: ', BaseDps.dps); // console.log('Yjj.getSupportContext()', Yjj.getSupportContext());
    ...
    const YuanQiCoe = (YuanQiDps.dps / BaseDps.dps - 1) * 100; // console.log('元气面板');
    // Yjj.showCoreValue();
    ...
    console.log('基础系数', JiChuCoe); // const JiChuYjj = new Calculator.YiJinJing({
    //   core: {
    //     ...baseCore,
