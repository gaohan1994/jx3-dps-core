...
export const getYuanQiAttribute = (attributes: any) => getTargetAttribute(attributes, CoreEnum.YuanQi);
...
export const transferHuiXinLevelToHuiXin = (huiXinLevel: number): number => huiXinLevel / HUIXIN_LEVEL_COE;

const HUIXIAO_LEVEL_COE = 125.0625;
export const transferHuiXiaoLevelToHuiXiao = (huiXiaoLevel: number): number => huiXiaoLevel / HUIXIAO_LEVEL_COE;

const POFANG_COE = 357.375;
export const transferPoFangLevelToPoFang = (poFangLevel: number): number => poFangLevel / POFANG_COE;

const WUSHUANG_COE = 344.5875;
export const transferWuShuangLevelToWuShuang = (wuShuangLevel: number): number => wuShuangLevel / WUSHUANG_COE;
